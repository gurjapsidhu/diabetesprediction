...
def app():
    ...
    st.image(img, caption="AI-Powered Tool", use_column_width=True)
    ...
    # Predict Button alignment
    st.markdown("<div class='predict-button'><button class='button'>Predict Again</button></div>", unsafe_allow_html=True)
